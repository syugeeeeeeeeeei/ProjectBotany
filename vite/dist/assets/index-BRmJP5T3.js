...
草刈り機などで地上部を刈り取る。低コストだが、種子を広げるなど逆効果となる場合がある。`,cost:1,cardType:"eradication",deckCount:1,imagePath:"/actions/erad/kariharai.png",range:{shape:"cross",scale:1},transition:[{target:["alien","alien-core"],result:"bare"}],eradicationType:"simple"},{id:"erad-2",name:"手取り除草",description:`【簡易駆除】十字範囲
手作業で抜き取る。範囲は広いが、根の断片を残すと再生を許してしまう。`,cost:2,cardType:"eradication",deckCount:1,imagePath:"/actions/erad/tedori.png",range:{shape:"range",scale:1},transition:[{target:["alien","alien-core"],result:"bare"}],eradicationType:"simple"},{id:"erad-3",name:"遮光シート",description:`【完全駆除】周囲
