...
const cardMasterData: CardDefinition[] = [
  // --- 外来種カード ---
  {
    id: "alien-1",
    name: "ナガミヒナゲシ",
    description: "特定外来生物ではないが、近年数を増やし侵略性が警戒される。\n少し毒があり、あまり警戒されずに徐々に勢力を広げる。\n\n[侵略]：左右1マス\n[クールタイム]：1ターン",
    cost: 1,
    cardType: "alien",
    deckCount: 2,
    imagePath: "/plants/ナガミヒナゲシ.png",
    targeting: { power: 1, shape: "straight", direction: "horizon" },
    cooldownTurns: 1,
    canGrow: false,
  },
  {
    ...
    targeting: { power: 1, shape: "straight", direction: "vertical" },
    cooldownTurns: 1,
    canGrow: false,
  },
  {
  ...
  },
  {
    id: "alien-4",
    name: "ミズバショウ",
    description: "諏訪地域では外来植物。\n大きな葉で広範囲の面積を奪う。\n全国的には希少なため安易に駆除できない。\n\n[侵略]：周囲1マス\n[成長]：1ターン後、侵略力3\n[クールタイム]：1ターン",
    cost: 3,
    cardType: "alien",
    deckCount: 1,
    imagePath: "/plants/ミズバショウ.png",
    targeting: { power: 2, shape: "range" },
    cooldownTurns: 1,
    canGrow: false,
  ...
  // --- 駆除カード ---
  {
    id: "erad-1",
    name: "引っこ抜き",
    description: "地道な手作業で、根本から確実に脅威を取り除く。\n\n[駆除]：侵略マス・上下1マス\n[駆除後状態]：空マス",
    cost: 1,
    cardType: "eradication",
    deckCount: 1,
    imagePath: "https://placehold.co/100x60/bcaaa4/795548?text=Tejime",
    targeting: { power: 1, shape: "straight", direction: "vertical", target: "alien_invasion_area" },
    postRemovalState: "empty_area",
  },
  {
    id: "erad-2",
    name: "早期発見・萌芽伐採",
    description: "外来種が種子を付ける前に伐採し、拡散を防ぐ。\n\n[駆除]：外来種コマ・十字1マス\n[駆除後状態]:再生待機マス\n[クールタイム]：1ターン",
    cost: 2,
    cardType: "eradication",
    deckCount: 1,
    imagePath: "https://placehold.co/100x60/ce93d8/9c27b0?text=Pinpoint",
    targeting: { power: 1, shape: "cross", target: "alien_core" },
  ...
  },
  {
    id: "erad-3",
    name: "遮光シート",
    description: "遮光シートを被せ、外来種の発芽を抑制する。\n\n[駆除]：侵略マス・周囲2マス\n[駆除後状態]：再生待機マス\n[クールタイム]：1ターン",
    cost: 3,
    cardType: "eradication",
    deckCount: 1,
    imagePath: "https://placehold.co/100x60/ef9a9a/f44336?text=Hiire",
    targeting: { power: 2, shape: "range", target: "alien_invasion_area" },
    postRemovalState: "recovery_pending_area",
    cooldownTurns: 1,
  },
  {
    id: "erad-4",
    name: "表土掘削",
    description: "重機を用いて表土を削り、根本から駆逐する。\n\n[駆除]：1種根絶やし\n[駆除後状態]：空マス\n[使用回数]：2回",
    cost: 4,
    cardType: "eradication",
    deckCount: 1,
  ...
  },
  {
    ...
    targeting: { power: 3, shape: "range", target: "alien_core" },
    postRemovalState: "empty_area",
    usageLimit: 1,
  },
  // --- 回復カード ---
  {
    ...
    targeting: { power: 1, shape: "single" },
  ...
  },
  {
    id: "recov-4",
    name: "帰化促進",
    description: "外来種の支配地域を、在来種の力で取り戻す。\n\n[回復]：1種の支配マス全て\n[回復後状態]：再生待機マス\n[使用回数]：2回",
    cost: 4,
    cardType: "recovery",
    deckCount: 1,
