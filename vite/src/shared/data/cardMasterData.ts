...
export const cardMasterData: CardDefinition[] = [
  ...
  // =================================================================
  {
    ...
    cardType: "alien",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/plants/ナガミヒナゲシ.png`,
  ...
  },
  {
    ...
    cardType: "alien",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/plants/ブラジルチドメグサ.png`,
  ...
  },
  {
    ...
    cardType: "alien",
    deckCount: 2,
    imagePath: `${import.meta.env.BASE_URL}/plants/オオキンケイギク.png`,
  ...
  },
  {
    ...
    cardType: "alien",
    deckCount: 2,
    imagePath: `${import.meta.env.BASE_URL}/plants/ミズバショウ.png`,
  ...
  },
  {
    ...
    cardType: "alien",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/plants/オオハンゴンソウ.png`,
  ...
  },
  {
    ...
    cardType: "alien",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/plants/アレチウリ.png`,
  ...
  // =================================================================
  {
    ...
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/eradication/刈り払い.png`,
  ...
  },
  {
    ...
    cardType: "eradication",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/eradication/手取り除草.png`,
  ...
  },
  {
    ...
    cardType: "eradication",
    deckCount: 2,
    imagePath: `${import.meta.env.BASE_URL}/eradication/遮光シート.png`,
    cooldownTurns: 1,
    range: { shape: "range", scale: 1 },
  ...
  },
  {
    ...
    name: "表土掘削",
    description:
      "【完全駆除】周囲\n種子を含んだ表土ごと重機で削り取る。広範囲を安全に浄化する。",
    cost: 4,
    cardType: "eradication",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/eradication/表土掘削.png`,
  ...
  },
  {
    ...
    cardType: "eradication",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/eradication/抜本的駆除計画.png`,
  ...
  // =================================================================
  {
    ...
    cardType: "recovery",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/recovery/客土（土入れ）.png`,
    range: { shape: "cross", scale: 1 },
  ...
  },
  {
    ...
    cardType: "recovery",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/recovery/在来種植栽.png`,
    range: { shape: "range", scale: 1 },
  ...
  },
  {
    ...
    cardType: "recovery",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/recovery/河川環境管理.png`,
  ...
  },
  {
    ...
    cardType: "recovery",
    deckCount: 1,
    imagePath: `${import.meta.env.BASE_URL}/recovery/大地の恵み.png`,
    range: { shape: "range", scale: 2 }, // 周囲2マス（5x5）
