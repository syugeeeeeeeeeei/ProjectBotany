 ...
 */
const PlayerControls: React.FC<PlayerControlProps> = ({
  name,
  currentPage,
  maxPage,
  onNext,
      ...
      <DialogContainer $isOpen={isOpen}>
        ...
        <Section>
          ...
          <ControlRow>
            ...
            <input
              type="checkbox"
              id="toggle-gesture-area"
              checked={isGestureAreaVisible}
              onChange={() =>
                onSetDebugSettings((s) => ({
                  ...s,
                  isGestureAreaVisible: !s.isGestureAreaVisible,
                }))
              }
            />
          </ControlRow>
          ...
          <SliderRow>
            ...
            <input
              ...
              onChange={(e) =>
                onSetDebugSettings((s) => ({
                  ...s,
                  swipeAreaHeight: parseFloat(e.target.value),
                }))
              }
          ...
          <SliderRow>
            ...
            <input
              ...
              onChange={(e) =>
                onSetDebugSettings((s) => ({
                  ...s,
                  flickDistanceRatio: parseFloat(e.target.value),
                }))
              }
              style={{ gridColumn: "1 / -1" }}
            />
          ...
          <SliderRow>
            ...
            <input
              ...
              onChange={(e) =>
                onSetDebugSettings((s) => ({
                  ...s,
                  flickVelocityThreshold: parseFloat(e.target.value),
                }))
              }
              style={{ gridColumn: "1 / -1" }}
            />
        ...
        <Section>
          ...
          <ControlRow>
            ...
            <div>
              <button
                onClick={() => onSetCardMultiplier((m) => Math.max(1, m - 1))}
              >
                -
              </button>
              <span> x{cardMultiplier} </span>
              <button onClick={() => onSetCardMultiplier((m) => m + 1)}>
                +
              </button>
            </div>
          </ControlRow>
