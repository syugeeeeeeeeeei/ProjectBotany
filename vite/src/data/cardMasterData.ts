...
const cardMasterData: CardDefinition[] = [
	// --- 外来種カード ---
	{
		...
		name: "ナガミヒナゲシ",
		description:
			"特定外来生物ではないが、近年数を増やし侵略性が警戒されている。\n少し毒があり、あまり警戒されずに徐々に勢力を広げる。\n十字状に1マスずつ侵略する。",
		cost: 1,
		cardType: "alien",
		deckCount: 2,
		imagePath: "https://placehold.co/100x60/ffcdd2/f44336?text=Nagami",
		baseInvasionPower: 1,
	...
	},
	{
		...
		name: "ブラジルチドメクサ",
		description:
			"特定外来生物。アクアリウムから逸出し、河川や水路で繁殖する。\n茎だけでも増殖するため、駆除が困難。\n直線状に1マス侵略する。",
		cost: 1,
		cardType: "alien",
		deckCount: 2,
		imagePath: "https://placehold.co/100x60/c8e6c9/4caf50?text=Brazil",
		baseInvasionPower: 1,
		baseInvasionShape: "straight",
		canGrow: false,
	},
	{
		id: "alien-3",
		name: "オオキンケイギク",
		description:
			"特定外来生物。観賞用に持ち込まれたが、繁殖・拡散が速い。\n道路沿いなどに多く、在来種を駆逐する。\n2ターン後に成長し、侵略力が上昇する。",
		cost: 2,
		cardType: "alien",
		deckCount: 2,
		imagePath: "https://placehold.co/100x60/fff9c4/ffeb3b?text=Ookin",
		baseInvasionPower: 1,
		baseInvasionShape: "cross",
		canGrow: true,
	...
	},
	{
		...
		name: "ミズバショウ",
		description:
			"諏訪地域では外来植物。大きな葉で広範囲の面積を奪う。\n全国的には希少なため安易に駆除できず、戦略的な対応が求められる。\n範囲状に2マスずつ侵略する。",
		cost: 3,
		cardType: "alien",
		deckCount: 1,
		imagePath: "https://placehold.co/100x60/e1f5fe/03a9f4?text=Mizubasho",
		baseInvasionPower: 2,
	...
	},
	{
		...
		name: "オオハンゴンソウ",
		description:
			"特定外来生物。低木と競合するほど強く、森や山を侵す。\n根だけでも増えるため、駆除が困難。\n初期から高い侵略力を持つため、放置は危険。",
		cost: 4,
		cardType: "alien",
		deckCount: 1,
		imagePath: "https://placehold.co/100x60/fbe9e7/ff5722?text=Oohangon",
		baseInvasionPower: 3,
		baseInvasionShape: "cross",
		canGrow: false,
	},
	{
		...
		name: "アレチウリ",
		description:
			"特定外来生物。つるを伸ばし、樹木や河川敷を覆い尽くす。\n密集して繁茂するため、物理的な駆除が難しい。\n広範囲を侵略し、2ターン後にさらに成長する。",
		cost: 5,
		cardType: "alien",
		deckCount: 1,
		imagePath: "https://placehold.co/100x60/d1c4e9/673ab7?text=Arechiuri",
		baseInvasionPower: 1,
		baseInvasionShape: "range",
		canGrow: true,
		growthConditions: [{ type: "turns_since_last_action", value: 2 }],
	...
	},
	{
		...
		name: "天敵導入",
		description:
			"特定の外来種のみを捕食する生物を導入し、生態系ごと対処する。\n指定した外来種コマと、その支配マス全体を駆除する。\nゲーム中2回まで使用可能。",
		cost: 4,
		cardType: "eradication",
		deckCount: 1,
		imagePath: "https://placehold.co/100x60/a5d6a7/4caf50?text=Tenteki",
		removalMethod: "target_alien_and_its_dominant_cells",
		targetType: "alien_plant",
		usageLimit: 2,
	},
	{
		id: "erad-5",
	...
	},
	{
		...
		recoveryMethod: "range_selection",
		cooldownTurns: 1,
	},
	{
		id: "recov-4",
		name: "自然公園の整備",
		description:
			"人の手で環境を整え、在来種の保護区を創出する。\n指定マス中心の2x2マスを在来種マスに回復する。\nゲーム中2回まで使用可能。",
		cost: 4,
		cardType: "recovery",
		deckCount: 1,
		imagePath: "https://placehold.co/100x60/bbdefb/2196f3?text=Koen",
		recoveryMethod: "range_selection",
		usageLimit: 2,
	},
	{
